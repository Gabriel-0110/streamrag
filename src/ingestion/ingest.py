...
def ingest_paths(paths: List[str], source: str | None = None, max_chars: int = 1200, overlap: int = 150) -> int:
    """
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Ingest local TXT/PDF files into Supabase")
    ...
    count = ingest_paths(args.paths, source=args.source, max_chars=args.max_chars, overlap=args.overlap)
